...
public class ResultFragment extends Fragment {
    ...
    private void init() {
        ...
        leftRotate = (Button) view.findViewById(R.id.rotate_left);
        leftRotate.setOnClickListener(new LeftRotateButtonClickListener());
        rightRotate = (Button) view.findViewById(R.id.rotate_right);
        rightRotate.setOnClickListener(new RightRotateButtonClickListener());
        mirror = (Button) view.findViewById(R.id.mirror);
    ...
    private class LeftRotateButtonClickListener implements View.OnClickListener {
        ...
        public void onClick(final View v) {
            ...
            AsyncTask.execute(new Runnable() {
                ...
                public void run() {
                    try {
                        transformed = ((ScanActivity) getActivity()).getLeftRotateBitmap(original);
                    } catch (final OutOfMemoryError e) {
                        getActivity().runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
    ...
    private class RightRotateButtonClickListener implements View.OnClickListener {
        ...
        public void onClick(final View v) {
            ...
            AsyncTask.execute(new Runnable() {
                ...
                public void run() {
                    try {
                        transformed = ((ScanActivity) getActivity()).getRightRotateBitmap(original);
                    } catch (final OutOfMemoryError e) {
                        getActivity().runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
    ...
    private class MirrorButtonClickListener implements View.OnClickListener {
        ...
        public void onClick(final View v) {
            ...
            AsyncTask.execute(new Runnable() {
                ...
                public void run() {
                    try {
                        transformed = ((ScanActivity) getActivity()).getMirrorBitmap(original);
                    } catch (final OutOfMemoryError e) {
                        getActivity().runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
