...
class OpenCvUtils {
    ...
    companion object {
        ...
        /*
        * Get crop image corners with edge detection
        * */
        fun getOutlinePointsWithoutEdgeDetection(bitmap: Bitmap): Map<Int, Point> {
            val outlinePoints = HashMap<Int, Point>()
            outlinePoints[0] = Point(0f.toDouble()+100, 0f.toDouble()+100)
            outlinePoints[1] = Point(bitmap.width.toDouble()-100, 0f.toDouble()+100)
            outlinePoints[2] = Point(0f.toDouble()+100, bitmap.height.toDouble() - 100)
            outlinePoints[3] = Point(bitmap.width.toDouble()-100, bitmap.height.toDouble()-130)
...
//        Bitmap ex24 = convertMatToBitmap(matReceipt);
        ...
        private fun getPointTlWithMaxLength(
            ...
            if (listPointInContour == null || listPointInContour.isEmpty())
                return null
